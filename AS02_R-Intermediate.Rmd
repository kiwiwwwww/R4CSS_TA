...
#kiwiの整理
#odd_day <-vector_weekday[seq(from=1,to=5,by=2)]
#even_day <-vector_weekday[seq(from=2,to=5,by=2)]
#odd_eat <-vector_shop[str_length(vector_shop)%% 2 == 1]
#even_eat <-vector_shop[str_detect(vector_shop,"水餃")==TRUE]  
#saturday_eat <-vector_shop[str_detect(vector_shop,"館")==TRUE]  

for (x in vector_weekday){ 
   if (x %in% vector_weekday[seq(from=1,to=5,by=2)]){
   y <- for (y in vector_shop[str_length(vector_shop)%% 2 == 1])
   print(str_c(x,"小軒吃",y))

}else if (x %in% vector_weekday[seq(from=2,to=5,by=2)]){
   y <- for (y in vector_shop[str_detect(vector_shop,"水餃")==TRUE] )
   print(str_c(x,"小軒吃",y))

}else if (x == vector_weekday[6]){
   y <- for (y in vector_shop[str_detect(vector_shop,"館")==TRUE] )
   print(str_c(x,"小軒吃",y))

}else{(x == vector_weekday[7])
   print(str_c("週日小軒都不吃"))}    
}
...
if (x %in% vector_weekday[seq(from=1,to=5,by=2)]){
if (y %in% vector_shop[str_length(vector_shop)%%2 == 1]){
   print(str_c(x,"小軒吃",y))
}else{
   print(str_c(x,"小軒不吃",y))  
      ...
      if (y %in% vector_shop[str_detect(vector_shop,"水餃")==TRUE]){
   print(str_c(x,"小軒吃",y))
}else{
   print(str_c(x,"小軒不吃",y))  
}
      ...
      if (y %in% vector_shop[str_detect(vector_shop,"館")==TRUE]){
   print(str_c(x,"小軒吃",y))
}else{
   print(str_c(x,"小軒不吃",y))  
}
