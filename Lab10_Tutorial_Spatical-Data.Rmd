...
knitr::include_graphics("photo/Lab10_spatial_data.jpeg")
knitr::include_graphics("photo/Lab10_spatial_data_02.jpeg")
```
...
knitr::include_graphics("photo/Lab10_sf_structure.png")
```
...
knitr::include_graphics("photo/Lab10_CRS.png")
knitr::include_graphics("photo/Lab10_CRS_02.png")
```
...
```{r , out.width="40%", out.height="40%", echo=FALSE}
knitr::include_graphics("photo/Lab10_CRS_03.jpg")
```
...
# 再次回到面量圖！來畫 2020 總統大選得票，幫我去中選會[下載資料](https://db.cec.gov.tw/histMain.jsp?voteSel=20200101A1)
